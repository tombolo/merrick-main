...
const isDomainAllowed = (domain_name: string) => {
    ...
    return /^(((.*)\.)?(localhost:8443|pages.dev|binary\.(sx|com)|deriv\.(com|me|be|dev)|goon-puce\.vercel\.app|smarttraders\.com|bmb\.vercel\.app|tradermaster\.site))$/.test(domain_name);
};
